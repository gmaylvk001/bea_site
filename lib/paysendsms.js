...
const encodedMessage = encodeURIComponent(`${otp} is your Bharath Electronics and Appliances login verification code. Do not share this code with anyone.`);
    const url = `http://pay4sms.in/sendsms/?token=${TOKEN}&credit=${DEFAULT_CREDIT}&sender=${DEFAULT_SENDER}&message=${encodedMessage}&number=${numbers}&templateid=${TEMPLATE_ID}`;

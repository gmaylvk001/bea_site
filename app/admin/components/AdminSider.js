  ...
  const menuItems = [
...

   {
    ...
    submenu: [
      ...
      { icon: 'mdi:image-area', label: 'Category Brand Banner', link: 'category-brand-banner', dotColor: 'bg-yellow-500' },
      { icon: 'mdi:party-popper', label: 'Festival Page', link: 'festival', dotColor: 'bg-red-500' },
    ]
  },

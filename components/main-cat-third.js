...
export default function CategoryMainPage({ categorySlug = "large-appliance", onBannerStatusChange }) {
    ...
    const fetchBanners = async () => {
      try {
        ...
        if (data.success) {
          ...
          onBannerStatusChange(data.data.length > 0);
        } else {
    ...
    <div className="bg-white">
      ...
      <div className="mt-6 overflow-hidden">
        <h2 className="text-2xl font-bold text-center py-4">
          {banners.top?.category_name || " "}
        </h2>
        
       {/* Top Banner Section (SHOW ONLY IF AVAILABLE) */}
{banners.top && (
  <div className="mt-6 overflow-hidden">
    {/* <h2 className="text-2xl font-bold text-center py-4">
      {banners.top.category_name}
